...
find "/Work18/2017/linan/ASR/keda/newtrain/aichallenge/train/1.getFB40/fb40" -name '*train*.fb' >train_list_fb.txt
find "/Work18/2017/linan/ASR/keda/newtrain/aichallenge/train/1.getFB40/fb40" -name '*dev*.fb'   >dev_list_fb.txt
